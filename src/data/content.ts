...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    technologies: ['Dell PowerEdge R750', 'Dell PowerStore', 'VMware vSphere 8', 'Cisco Catalyst 9300', 'Fortinet FortiGate', 'Veeam Backup', 'SolarWinds', 'Dell Networking'],
    timeline: '16 weeks',
    teamSize: '12 engineers',
    results: [
      { metric: 'Cost Reduction', value: '38%', description: 'Annual infrastructure operating costs reduced through consolidation and virtualization.' },
      { metric: 'Server Consolidation', value: '76%', description: 'Physical server count reduced from 500 to 120 high-performance virtual hosts.' },
      { metric: 'Uptime Achieved', value: '99.99%', description: 'Zero unplanned downtime since go-live, exceeding RBI availability requirements.' },
      { metric: 'Power Savings', value: '45%', description: 'Data center power consumption reduced through server consolidation and efficient hardware.' },
    ],
    testimonial: {
  ...
  },
  {
    ...
    technologies: ['HPE ProLiant DL380 Gen11', 'NetApp AFF A400', 'Cisco Catalyst 9200', 'HPE Aruba Wireless', 'Veeam Backup', 'VMware vSphere', 'Palo Alto PA-Series', 'Cisco MPLS'],
    timeline: '12 weeks',
    teamSize: '8 engineers',
    results: [
      { metric: 'System Availability', value: '99.99%', description: 'EMR system uptime ensuring uninterrupted clinical operations across all facilities.' },
      { metric: 'Response Time', value: '50% faster', description: 'EMR application response time improved from 4 seconds to under 2 seconds average.' },
      { metric: 'Storage Capacity', value: '500TB', description: 'Scalable NAS infrastructure for PACS with 5-year growth capacity built in.' },
      { metric: 'Facilities Connected', value: '5 sites', description: 'All hospital and clinic locations connected with redundant high-speed links.' },
    ],
    testimonial: {
  ...
  },
  {
    ...
    technologies: ['Cisco Catalyst 9300', 'Cisco Catalyst 9200', 'Cisco Meraki MR APs', 'Cisco ISE', 'Cisco Meraki MX', 'Structured Cabling (Cat6A)', 'Fiber Backbone', 'Cisco DNA Center'],
    timeline: '10 weeks',
    teamSize: '15 engineers',
    results: [
      { metric: 'Wi-Fi Coverage', value: '100%', description: 'Complete wireless coverage across all academic buildings, hostels, and common areas.' },
      { metric: 'Concurrent Users', value: '5000+', description: 'Network supporting 5000+ simultaneous wireless connections without degradation.' },
      { metric: 'Bandwidth', value: '10x increase', description: 'Campus backbone upgraded from 1Gbps to 10Gbps with Gigabit to every desktop.' },
      { metric: 'Network Segments', value: '4 zones', description: 'Secure segmentation for student, faculty, research, and guest networks.' },
    ],
    testimonial: {
  ...
  },
  {
    ...
    technologies: ['HPE ProLiant DL380 Gen11', 'HPE Nimble Storage', 'Fortinet FortiGate SD-WAN', 'Lenovo ThinkStation P360', 'Cisco Meraki MS Switches', 'VMware vSphere', 'Veeam Backup', 'APC Smart-UPS'],
    timeline: '14 weeks',
    teamSize: '10 engineers',
    results: [
      { metric: 'SAP Performance', value: '3x faster', description: 'SAP transaction processing 3x faster compared to legacy infrastructure.' },
      { metric: 'ROI Timeline', value: '18 months', description: 'Complete return on infrastructure investment within 18 months of deployment.' },
      { metric: 'Plants Connected', value: '3 sites', description: 'All manufacturing plants connected with sub-20ms latency SD-WAN.' },
      { metric: 'Data Protection', value: 'RPO < 15 min', description: 'Continuous replication ensuring minimal data loss in disaster scenarios.' },
    ],
    testimonial: {
  ...
  },
  {
    ...
    technologies: ['Dell PowerEdge R650', 'Pure Storage FlashArray//X', 'Cisco Catalyst 9300', 'Palo Alto PA-Series', 'VMware vSphere', 'F5 Load Balancers', 'Veeam Backup', 'Grafana Monitoring'],
    timeline: '8 weeks',
    teamSize: '6 engineers',
    results: [
      { metric: 'Capacity', value: '10x growth', description: 'Infrastructure scaled from 5,000 to 50,000+ concurrent users.' },
      { metric: 'Page Load Time', value: '<1 second', description: 'Average page load reduced from 8 seconds to under 1 second.' },
      { metric: 'Uptime During Sales', value: '100%', description: 'Zero downtime during three consecutive sale events after deployment.' },
      { metric: 'Revenue Impact', value: '+200%', description: 'Sale event revenue increased by 200% with the platform able to handle all traffic.' },
    ],
    testimonial: {
