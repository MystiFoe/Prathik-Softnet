...
export const Icons = {
  server: ({ className, size = 24 }: IconProps) => (
  ...
  package: ({ className, size = 24 }: IconProps) => (
  ...
  layout: ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
  ),
  ...
  indianRupee: ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 3h12"/><path d="M6 8h12"/><path d="m6 13 8.5 8"/><path d="M6 13h3"/><path d="M9 13c6.667 0 6.667-10 0-10"/></svg>
  ),
  ...
  landmark: ({ className, size = 24 }: IconProps) => (
  ...
  heartPulse: ({ className, size = 24 }: IconProps) => (
  ...
  factory: ({ className, size = 24 }: IconProps) => (
  ...
  monitor: ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>
  ),
  ...
  quote: ({ className, size = 24 }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}><path d="M11.3 4.8c-4 1.3-6.3 4.3-6.3 8.2 0 3.1 2 5 4.5 5 2.2 0 3.8-1.7 3.8-3.8 0-2.1-1.4-3.6-3.3-3.6-.4 0-.9.1-1.1.2.6-2.6 2.8-4.8 5.4-5.5L11.3 4.8zm10.4 0c-4 1.3-6.3 4.3-6.3 8.2 0 3.1 2 5 4.5 5 2.2 0 3.8-1.7 3.8-3.8 0-2.1-1.4-3.6-3.3-3.6-.4 0-.9.1-1.1.2.6-2.6 2.8-4.8 5.4-5.5L21.7 4.8z"/></svg>
  ),
  whatsapp: ({ className, size = 24 }: IconProps) => (
...
export function getIcon(name: string): React.FC<IconProps> | null {
  ...
  const key = iconMap[name] || (name as keyof typeof Icons);
